declare module 'sap/ui/demokit/IndexLayout' {
    ...
    export interface IIndexLayoutSettings extends IControlSettings {
    ...
    */
    export class IndexLayout extends Control {
        ...
        */
        public constructor(sId: string, mSettings: IIndexLayoutSettings);
