declare module 'sap/ui/core/tmpl/DOMAttribute' {
    ...
    export interface IDOMAttributeSettings extends IElementSettings {
        name?: string;
        value?: string;
    }
    ...
    */
    export class DOMAttribute extends Element {
        ...
        */
        public constructor(sId: string, mSettings: IDOMAttributeSettings);
