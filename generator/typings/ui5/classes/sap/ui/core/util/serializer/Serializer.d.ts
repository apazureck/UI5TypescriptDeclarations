declare module 'sap/ui/core/util/serializer/Serializer' {
    ...
    export interface ISerializerSettings extends IEventProviderSettings {
    }

    /**
    
    */
    export class Serializer extends EventProvider {

        /**
            * Serializer class. Iterates over all controls and call a given serializer delegate.
        */
        public constructor(oRootControl: Control | UIArea, serializeDelegate: {}, bSkipRoot: boolean, fnSkipAggregations: (() => any), fnSkipElement: (() => any));
