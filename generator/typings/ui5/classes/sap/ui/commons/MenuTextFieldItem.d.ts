declare module 'sap/ui/commons/MenuTextFieldItem' {
    ...
    import { MenuTextFieldItem as MenuTextFieldItemBase, IMenuTextFieldItemSettings as IMenuTextFieldItemBaseSettings } from 'sap/ui/unified/MenuTextFieldItem';

    export interface IMenuTextFieldItemSettings extends IMenuTextFieldItemBaseSettings {
    }

    /**
    
    */
    export class MenuTextFieldItem extends MenuTextFieldItemBase {
