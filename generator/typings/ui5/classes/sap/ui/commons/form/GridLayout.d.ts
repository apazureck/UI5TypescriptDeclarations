declare module 'sap/ui/commons/form/GridLayout' {
    ...
    import { GridLayout as GridLayoutBase, IGridLayoutSettings as IGridLayoutBaseSettings } from 'sap/ui/layout/form/GridLayout';

    export interface IGridLayoutSettings extends IGridLayoutBaseSettings {
    }
