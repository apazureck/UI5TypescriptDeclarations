declare module 'sap/ui/commons/form/FormContainer' {
    ...
    import { FormContainer as FormContainerBase, IFormContainerSettings as IFormContainerBaseSettings } from 'sap/ui/layout/form/FormContainer';

    export interface IFormContainerSettings extends IFormContainerBaseSettings {
    }

    /**
    
    */
    export class FormContainer extends FormContainerBase {
