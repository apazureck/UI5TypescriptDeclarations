declare module 'sap/ui/model/odata/type/Guid' {
    ...
    export interface IGuidSettings extends IODataTypeSettings {
    }

    /**
    
    */
    export class Guid extends ODataType {
        ...
        */
        ...
        /**
            * Creates a new subclass of class sap.ui.model.odata.type.Guid with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
