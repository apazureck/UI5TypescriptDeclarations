declare module 'sap/ui/unified/calendar/YearPicker' {
    ...
    export interface IYearPickerSettings extends IControlSettings {
        year?: number;
        years?: number;
        columns?: number;
        date?: {};
    ...
    */
    export class YearPicker extends Control {
        ...
        */
        public constructor(sId: string, mSettings: IYearPickerSettings);
