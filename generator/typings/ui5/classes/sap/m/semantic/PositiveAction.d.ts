declare module 'sap/m/semantic/PositiveAction' {
    ...
    export interface IPositiveActionSettings extends ISemanticButtonSettings {
        text?: string;
    }
    ...
    */
    export class PositiveAction extends SemanticButton {
        ...
        */
        public constructor(sId: string, mSettings: IPositiveActionSettings);
