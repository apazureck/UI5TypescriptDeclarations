declare module 'sap/m/semantic/NegativeAction' {
    ...
    export interface INegativeActionSettings extends ISemanticButtonSettings {
        text?: string;
    }
    ...
    */
    export class NegativeAction extends SemanticButton {
        ...
        */
        public constructor(sId: string, mSettings: INegativeActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.NegativeAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
