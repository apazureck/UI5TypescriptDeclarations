declare module 'sap/m/semantic/SendEmailAction' {
    ...
    export interface ISendEmailActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class SendEmailAction extends SemanticButton {

        /**
            * Constructor for a new SendEmailAction.
        */
        public constructor(sId: string, mSettings: ISendEmailActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.SendEmailAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
