declare module 'sap/m/semantic/MessagesIndicator' {
    ...
    export interface IMessagesIndicatorSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class MessagesIndicator extends SemanticButton {

        /**
            * Constructor for a new MessagesIndicator.
        */
        public constructor(sId: string, mSettings: IMessagesIndicatorSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.MessagesIndicator with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
