declare module 'sap/m/semantic/DeleteAction' {
    ...
    export interface IDeleteActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class DeleteAction extends SemanticButton {

        /**
            * Constructor for a new DeleteAction.
        */
        public constructor(sId: string, mSettings: IDeleteActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.DeleteAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
