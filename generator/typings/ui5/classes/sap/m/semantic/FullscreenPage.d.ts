declare module 'sap/m/semantic/FullscreenPage' {
    ...
    export interface IFullscreenPageSettings extends IShareMenuPageSettings {
    }

    /**
    
    */
    export class FullscreenPage extends ShareMenuPage {
        ...
        */
        public constructor(sId: string, mSettings: IFullscreenPageSettings);
