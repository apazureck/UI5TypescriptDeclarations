declare module 'sap/m/semantic/FlagAction' {
    ...
    export interface IFlagActionSettings extends ISemanticToggleButtonSettings {
    }

    /**
    
    */
    export class FlagAction extends SemanticToggleButton {

        /**
            * Constructor for a new FlagAction.
        */
        public constructor(sId: string, mSettings: IFlagActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.FlagAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
