declare module 'sap/m/semantic/FilterSelect' {
    ...
    export interface IFilterSelectSettings extends ISemanticSelectSettings {
    }

    /**
    
    */
    export class FilterSelect extends SemanticSelect {

        /**
            * Constructor for a new FilterSelect.
        */
        public constructor(sId: string, mSettings: IFilterSelectSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.FilterSelect with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
