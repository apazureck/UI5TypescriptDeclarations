declare module 'sap/m/semantic/AddAction' {
    ...
    export interface IAddActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class AddAction extends SemanticButton {

        /**
            * Constructor for a new AddAction.
        */
        public constructor(sId: string, mSettings: IAddActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.AddAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
