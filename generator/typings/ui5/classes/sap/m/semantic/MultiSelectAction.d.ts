declare module 'sap/m/semantic/MultiSelectAction' {
    ...
    export interface IMultiSelectActionSettings extends ISemanticToggleButtonSettings {
    }

    /**
    
    */
    export class MultiSelectAction extends SemanticToggleButton {

        /**
            * Constructor for a new MultiSelectAction.
        */
        public constructor(sId: string, mSettings: IMultiSelectActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.MultiSelectAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
