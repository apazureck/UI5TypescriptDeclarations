declare module 'sap/m/semantic/PrintAction' {
    ...
    export interface IPrintActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class PrintAction extends SemanticButton {

        /**
            * Constructor for a new PrintAction.
        */
        public constructor(sId: string, mSettings: IPrintActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.PrintAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
