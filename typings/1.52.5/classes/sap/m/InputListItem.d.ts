declare module 'sap/m/InputListItem' {
    ...
    export interface IInputListItemSettings extends IListItemBaseSettings {
        label?: string;
    ...
    */
    export class InputListItem extends ListItemBase {
        ...
        */
        public constructor(sId: string, mSettings: IInputListItemSettings);
