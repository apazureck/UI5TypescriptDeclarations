declare module 'sap/m/semantic/FilterAction' {
    ...
    export interface IFilterActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class FilterAction extends SemanticButton {

        /**
            * Constructor for a new FilterAction.
        */
        public constructor(sId: string, mSettings: IFilterActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.FilterAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
