declare module 'sap/m/semantic/ForwardAction' {
    ...
    export interface IForwardActionSettings extends ISemanticButtonSettings {
    }

    /**
    
    */
    export class ForwardAction extends SemanticButton {

        /**
            * Constructor for a new ForwardAction.
        */
        public constructor(sId: string, mSettings: IForwardActionSettings);


        /**
            * Creates a new subclass of class sap.m.semantic.ForwardAction with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
