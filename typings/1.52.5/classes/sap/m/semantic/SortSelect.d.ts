declare module 'sap/m/semantic/SortSelect' {
    ...
    export interface ISortSelectSettings extends ISemanticSelectSettings {
    }

    /**
    
    */
    export class SortSelect extends SemanticSelect {

        /**
            * Constructor for a new SortSelect.
        */
        public constructor(sId: string, mSettings: ISortSelectSettings);
