declare module 'sap/m/OverflowToolbarToggleButton' {
    ...
    import { ToggleButton, IToggleButtonSettings } from 'sap/m/ToggleButton';

    export interface IOverflowToolbarToggleButtonSettings extends IToggleButtonSettings {
    }

    /**
    
    */
    export class OverflowToolbarToggleButton extends ToggleButton {

        /**
            * Constructor for a new `OverflowToolbarToggleButton`.
        */
        public constructor(sId: string, mSettings: IOverflowToolbarToggleButtonSettings);
