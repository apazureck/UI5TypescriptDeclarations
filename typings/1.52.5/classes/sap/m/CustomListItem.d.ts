declare module 'sap/m/CustomListItem' {
    ...
    export interface ICustomListItemSettings extends IListItemBaseSettings {
    }

    /**
    
    */
    export class CustomListItem extends ListItemBase {
        ...
        */
        public constructor(sId: string, mSettings: ICustomListItemSettings);
        ...
        */
        ...
        /**
            * Creates a new subclass of class sap.m.CustomListItem with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
