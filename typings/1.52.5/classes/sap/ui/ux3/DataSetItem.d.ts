declare module 'sap/ui/ux3/DataSetItem' {
    ...
    export interface IDataSetItemSettings extends IElementSettings {
    ...
    */
    export class DataSetItem extends Element {
        ...
        */
        public constructor(sId: string, mSettings: IDataSetItemSettings);
        ...
        */
        attachSelected<Tcontext>(fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the selected Datset item */
            itemId: string,
         ...
         * Event Fired when Datset item is selected.
        */
        attachSelected<TcustomData, Tcontext>(oData: {}, fnFunction: (this: Tcontext, oEvent: Event<this, { /* * Id of the selected Datset item */
            itemId: string,
