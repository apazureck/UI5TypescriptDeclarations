declare module 'sap/ui/commons/Callout' {
    ...
    export interface ICalloutSettings extends ICalloutBaseSettings {
    }
    ...
    */
    export class Callout extends CalloutBase {
        ...
        */
        public constructor(sId: string, mSettings: ICalloutSettings);
        ...
        */
        ...
        /**
            * Creates a new subclass of class sap.ui.commons.Callout with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
