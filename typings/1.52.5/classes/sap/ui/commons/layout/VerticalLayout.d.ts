declare module 'sap/ui/commons/layout/VerticalLayout' {
    ...
    import { VerticalLayout as VerticalLayoutBase, IVerticalLayoutSettings as IVerticalLayoutBaseSettings } from 'sap/ui/layout/VerticalLayout';

    export interface IVerticalLayoutSettings extends IVerticalLayoutBaseSettings {
    }

    /**
    
    */
    export class VerticalLayout extends VerticalLayoutBase {
