declare module 'sap/ui/demokit/UIAreaSubstitute' {
    ...
    export interface IUIAreaSubstituteSettings extends IElementSettings {
    }

    /**
    
    */
    export class UIAreaSubstitute extends Element {
        ...
        */
        public constructor(sId: string, mSettings: IUIAreaSubstituteSettings);
        ...
        */
        ...
        /**
            * Creates a new subclass of class sap.ui.demokit.UIAreaSubstitute with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
