declare module 'sap/ui/core/mvc/TemplateView' {
    ...
    export interface ITemplateViewSettings extends IViewSettings {
    }
    ...
    */
    export class TemplateView extends View {
        ...
        */
        public constructor(sId: string, mSettings: ITemplateViewSettings);


        /**
            * Creates a new subclass of class sap.ui.core.mvc.TemplateView with name `sClassName` and enriches it with the information contained in `oClassInfo`.
         * 
