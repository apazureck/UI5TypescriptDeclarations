declare module 'sap/tnt/ToolHeaderUtilitySeparator' {
    ...
    export interface IToolHeaderUtilitySeparatorSettings extends IControlSettings {
    }

    /**
    
    */
    export class ToolHeaderUtilitySeparator extends Control {
        ...
        */
        public constructor(sId: string, mSettings: IToolHeaderUtilitySeparatorSettings);
