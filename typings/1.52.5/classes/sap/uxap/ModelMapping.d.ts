declare module 'sap/uxap/ModelMapping' {
    ...
    export interface IModelMappingSettings extends IElementSettings {
    ...
    */
    export class ModelMapping extends Element {
        ...
        */
        public constructor(sId: string, mSettings: IModelMappingSettings);
